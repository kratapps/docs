        ...
        ((e) => {
            ...
            ((e) => {
                if (Array.isArray(e.begin)) {
                    ...
                    if ('object' != typeof e.beginScope || null === e.beginScope) throw (W('beginScope must be object'), K);
            ...
            ((e) => {
                if (Array.isArray(e.end)) {
                    ...
                    if ('object' != typeof e.endScope || null === e.endScope) throw (W('endScope must be object'), K);
            ...
            (function n(o, r) {
                ...
                return (
                    'object' == typeof o.keywords &&
                        o.keywords.$pattern &&
                        ((o.keywords = Object.assign({}, o.keywords)), (c = o.keywords.$pattern), delete o.keywords.$pattern),
                    (c = c || /\w+/),
                    ...
                    r &&
                        ...
                        o.endsWithParent && r.terminatorEnd && (a.terminatorEnd += (o.end ? '|' : '') + r.terminatorEnd)),
            ...
            function E(e, n, s, o) {
                ...
                function l() {
                    ...
                    for (; t; ) {
                        ...
                        if (o) {
                            const [e, i] = o;
                            if ((M.addText(n), (n = ''), (c[s] = (c[s] || 0) + 1), c[s] <= 7 && (j += i), e.startsWith('_'))) n += t[0];
                            else {
                ...
                function h(e, t) {
                    return (
                        e.scope && 'string' == typeof e.scope && M.openNode(_.classNameAliases[e.scope] || e.scope),
                        e.beginScope &&
                            (e.beginScope._wrap
                ...
                function y(i, o) {
                    ...
                    if (((w = o), 'begin' === o.type))
                        return ((e) => {
                            ...
                            return (
                                i.skip ? (R += n) : (i.excludeBegin && (R += n), g(), i.returnBegin || i.excludeBegin || (R = n)),
                                h(i, e),
                ...
                try {
                    ...
                    return M.finalize(), (k = M.toHTML()), { language: e, value: k, relevance: j, illegal: !1, _emitter: M, _top: N };
                } catch (t) {
                    if (t.message && t.message.includes('Illegal'))
                        return {
                            ...
                            illegal: !0,
                            relevance: 0,
                            _illegalBy: { message: t.message, index: A, context: n.slice(A - 100, A + 100), mode: t.mode, resultSoFar: k },
                            _emitter: M
                        };
                    if (r)
                        return {
            ...
            function w(e) {
                ...
                const n = ((e) => {
                    ...
                    if (n) {
                        const t = O(n[1]);
                        return (
                            t || (X(a.replace('{}', n[1])), X('Falling back to no-highlight mode for this block.', e)),
                            t ? n[1] : 'no-highlight'
                        );
                    }
                ...
                Object.assign(n, {
                    ...
                    registerLanguage: (e, t) => {
                        ...
                        try {
                            ...
                            if ((W("Language definition for '{}' could not be registered.".replace('{}', e)), !r)) throw t;
                            W(t), (s = l);
                        }
                        s.name || (s.name = e),
                            (i[e] = s),
...
(() => {
    var e = (() => {
        ...
        return (e) => {
            ...
            a.contains.push(o);
            const r = { begin: /\$?\(\(/, end: /\)\)/, contains: [{ begin: /\d+#[0-9a-f]+/, className: 'number' }, e.NUMBER_MODE, t] },
            ...
            const a = n.regex,
                l = ((e) => ({
                    ...
                    CSS_NUMBER_MODE: {
                        scope: 'number',
                        begin:
                            e.NUMBER_RE + '(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?',
                        relevance: 0
                    },
                    ...
                    },
                    {
                        ...
                        contains: [
                            ...
                            ...s,
                            {
                                ...
                                contains: [...s, { className: 'string', begin: /[^)]/, endsWithParent: !0, excludeEnd: !0 }]
                            },
                            l.FUNCTION_DISPATCH
                        ]
                    },
    ...
    var e = (() => {
        ...
        return (o) => {
            const l = o.regex,
                ...
                h = { begin: 'html`', end: '', starts: { end: '`', returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, y], subLanguage: 'xml' } },
                N = {
                    begin: 'css`',
                    end: '',
            ...
            const S = [].concat(v, y.contains),
                ...
                R = { className: 'params', begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: g, contains: w },
                O = {
                    variants: [
                        {
                                ...
                                contains: [
                                    {
                                        ...
                                        variants: [
                                            ...
                                            { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: g, contains: w }
                                        ]
                                    }
                                ]
                            },
    ...
    var e = (() => {
        ...
        return (e) => {
            ...
            return {
                ...
                contains: [
                    { begin: r.either(...s), relevance: 0, keywords: { $pattern: /[\w\.]+/, keyword: c.concat(s), literal: n, type: a } },
                    { className: 'type', begin: r.either('double precision', 'large object', 'with timezone', 'without timezone') },
                    l,
    ...
    var e = (() => {
        ...
        function o(o) {
            const l = o.regex,
                ...
                p = { begin: 'html`', end: '', starts: { end: '`', returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, A], subLanguage: 'xml' } },
                N = {
                    begin: 'css`',
                    end: '',
                ...
                f = {
                    ...
                    starts: { end: '`', returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, A], subLanguage: 'graphql' }
                },
